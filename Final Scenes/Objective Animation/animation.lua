...
ball:translate(-20+41*t/90,12*math.abs(math.cos(2*math.pi*t/90))*math.exp(-0.5*t/30)-9,-13)
...
spinner = gr.mesh("spinner", "Spinner.obj")
...
cow_instance:translate(0.38-0.71*t/90,0.35+1.732*math.sin(2*math.pi*t/270),-0.23+0.71*t/90)
